...
usage() {
  echo "Usage: $0 [-h] SOURCE_IMAGE_ID TARGET_ACCOUNT[,TARGET_ACCOUNT2...]"
  exit 1
}
...
snapshot_ids=$(aws ec2 describe-images --image-ids $source_image_id \
...
for account in "${target_accounts[@]}" ; do
  ...
  for snapshot_id in $snapshot_ids ; do
    ...
    echo "Adding create volume permission for $account to snapshot $snapshot_id..."
